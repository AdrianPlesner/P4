...
public final class ABoolOpExpr extends PExpr
{
    ...
    public ABoolOpExpr(
        ...
        @SuppressWarnings("hiding") TBoolOp _operator_,
    ...
    public TBoolOp getOperator()
    {
        return this._operator_;
    }

    public void setOperator(TBoolOp node)
    {
